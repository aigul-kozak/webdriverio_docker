...
export const config = {
        ...
        : {
            'goog:chromeOptions': {
              args: [
                ...
                ...(process.env.DOCKER === 'true' || process.platform === 'linux'
  ...
  beforeSuite: function (suite) {
    ...
    // Add browser as parent suite
    allure.addSuite(browserName);

    // Optionally add to environment for filtering
  ...
  beforeEach: function (test) {
    ...
    // Add browser name as a parent suite in Allure
    allure.addLabel('parentSuite', browserName);

    // Add browser info to environment for filtering in the report
    allure.addEnvironment('Browser', browserName);
  },
